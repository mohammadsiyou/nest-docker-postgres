...
const appointment: Appointment = { id: '111', startDate: new Date(), endDate: new Date(), isReserved: true, doctor: null, patient: null };
...
describe('DoctorsController', () => {
            ...
            providers: [
                ...
                AppointmentsService,
                {
                    ...
                    useValue: {
                        ...
                        getDoctorAppointments: jest.fn().mockImplementation((id: string) => Promise.resolve({ ...appointment, id })),
    ...
    describe('addAppointments', () => {
        it('should throw "endDate must be greater than startDate"', () => {
            expect(doctorsController.addAppointments('', { startDate: new Date(), endDate: new Date(Date.now() - 1) }))
        ...
        it('should throw "Doctor not found"', () => {
            ...
            expect(doctorsController.addAppointments('', { startDate: new Date(), endDate: new Date(Date.now()) }))
    ...
    describe('getAppointments', () => {
        ...
        it('should return an appointment', () => {
            jest.spyOn(doctorsController, 'findOne').mockImplementation(() => Promise.resolve({ ...createDoctorDto, id: '111', appointments: [] }));
    ...
    describe('deleteAppointment', () => {
        ...
        it('should throw "The appointment has taken."', () => {
            ...
            jest.spyOn(appointmentsService, 'getAppointment').mockImplementation(() => Promise.resolve({ ...appointment, isReserved: true }));
        ...
        it('"deleteAppointment" should be called', async () => {
            ...
            jest.spyOn(appointmentsService, 'getAppointment').mockImplementation(() => Promise.resolve({ ...appointment, isReserved: false }));
