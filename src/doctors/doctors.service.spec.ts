            ...
            providers: [
                DoctorsService,
                {
                    ...
                    useValue: {
                        ...
                        findOneBy: jest.fn().mockImplementation(({ id }: Doctor) => Promise.resolve({ ...createDoctorDto, id })),
                        create: jest.fn().mockImplementation((doctor: CreateDoctorDto) => doctor),
                        save: jest.fn().mockImplementation((doctor: CreateDoctorDto) => Promise.resolve({ ...doctor, id: '5555' })),
                        update: jest.fn(),
                        delete: jest.fn(),
                    }
                },
